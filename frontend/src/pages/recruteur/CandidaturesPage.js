...
const CandidaturesPage = () => {
        ...
        const mockCandidatures = [
          {
            ...
            messagePerso:
              "Je suis très intéressée par votre offre et je pense que mon expérience correspondrait parfaitement au poste.",
            notes: "",
            entretiens: [],
          },
          {
            ...
            messagePerso:
              "Passionné de mixologie, je souhaite mettre mes compétences au service de votre établissement.",
          ...
          },
          {
            ...
            messagePerso:
              "Je suis actuellement en poste mais souhaite évoluer dans un établissement comme le vôtre.",
          ...
          },
          {
            ...
            messagePerso:
              "Je recherche un nouveau défi culinaire et votre établissement correspond à mes aspirations.",
          ...
          },
          {
            ...
            messagePerso:
              "Trilingue avec expérience en hôtellerie de luxe, je serais ravie de rejoindre votre équipe.",
          ...
          },
          {
            ...
            messagePerso:
              "Je souhaite apporter mon savoir-faire et ma créativité à votre brigade.",
          ...
          },
          {
            ...
            messagePerso:
              "Passionné par l'univers du vin, je souhaite mettre mes connaissances à votre service.",
            notes: "Refusé car expérience insuffisante",
            entretiens: [],
            rejectReason:
              "Profil intéressant mais expérience insuffisante pour le poste",
          },
        ];
  ...
  const filteredCandidatures = candidatures.filter((candidature) => {
    ...
    if (
      tabValue === 2 &&
      !["contacted", "interview", "offer"].includes(candidature.status)
    ) {
      return false;
    }
  ...
  const renderStatus = (status) => {
    ...
    return (
      <Chip size="small" label={statusObj.label} color={statusObj.color} />
    );
  };
          ...
          <List sx={{ width: "100%", bgcolor: "background.paper", p: 0 }}>
            {sortedCandidatures.map((candidature, index) => (
              <React.Fragment key={candidature.id}>
                ...
                {index < sortedCandidatures.length - 1 && (
          ...
          {selectedCandidature && (
            <>
              <Typography variant="body2" gutterBottom>
                Candidature de {selectedCandidature.candidat.prenom}{" "}
