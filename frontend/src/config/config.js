...
const config = {
  ...
  // URLs OAuth
  oauth: {
    google: `${process.env.REACT_APP_API_URL || 'http://localhost:3000/api/v1'}/auth/google`,
    linkedin: `${process.env.REACT_APP_API_URL || 'http://localhost:3000/api/v1'}/auth/linkedin`,
  },
